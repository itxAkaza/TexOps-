...
import 'widgets/fabric_review_continue_button.dart';
...
class FabricTestingScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final FabricTestingController controller =
        Get.isRegistered<FabricTestingController>()
    ...
    if (!controller.didPrefill) {
      ...
      WidgetsBinding.instance.addPostFrameCallback((_) async {
        ...
        final QualityTestRecord? record =
            records[QualityTestCategory.fabric];
        if (record != null) {
    ...
    if (!controller.didAutoExpand) {
      ...
      controller.isStiffnessExpanded.value = true;
      WidgetsBinding.instance.addPostFrameCallback((_) {
        controller.stiffnessWeightFocus.requestFocus();
    ...
    return Scaffold(
      ...
      appBar: AppBarWithBack(title: 'Fabric Testing'),
            ...
            Padding(
              ...
              child: Column(
                children: [
                    ...
                    children: [
                      Obx(() {
                        final bool isExpanded =
                            controller.isStiffnessExpanded.value;
                      ...
                      Obx(() {
                        final bool isExpanded =
                            controller.isWarpCountExpanded.value;
                      ...
                      Obx(() {
                        final bool isExpanded =
                            controller.isWeftCountExpanded.value;
                      ...
                      Obx(() {
                        final bool isExpanded =
                            controller.isTensileStrengthExpanded.value;
                        ...
                        return StatelessExpandableInputCard(
                          ...
                          bottomWidget: Obx(
                            () => FabricCalculatedResultWidget(
                              ...
                              calculatedValue:
                                  controller.tensileStrengthResult.value,
                              units: 'N',
                            ),
                          ),
                        );
                      ...
                      Obx(() {
                        final bool isExpanded =
                            controller.isTearingStrengthExpanded.value;
                        ...
                        return StatelessExpandableInputCard(
                          ...
                          bottomWidget: Obx(
                            () => FabricCalculatedResultWidget(
                              ...
                              calculatedValue:
                                  controller.tearingStrengthResult.value,
                              units: 'N',
                            ),
                          ),
                        );
                      ...
                      Obx(() {
                        final bool isExpanded =
                            controller.isBurstingStrengthExpanded.value;
                        ...
                        return StatelessExpandableInputCard(
                          ...
                          bottomWidget: Obx(
                            () => FabricCalculatedResultWidget(
                              ...
                              calculatedValue:
                                  controller.burstingStrengthResult.value,
                              units: 'kPa',
                            ),
                          ),
                        );
                      ...
                      Obx(() {
                        final bool isExpanded =
                            controller.isCreaseRecoveryExpanded.value;
                        ...
                        return StatelessExpandableInputCard(
                          ...
                          bottomWidget: Obx(
                            () => FabricCalculatedResultWidget(
                              ...
                              calculatedValue:
                                  controller.creaseRecoveryResult.value,
                              units: '°',
                            ),
                          ),
                        );
                      ...
                      Obx(() {
                        final bool isExpanded =
                            controller.isKnitTypeExpanded.value;
                        ...
                        return StatelessExpandableInputCard(
                          ...
                          bottomWidget: Obx(
                            () => KnitTypeWidget(
                              ...
                              onChanged: (value) =>
                                  controller.selectedKnitType.value = value,
                            ),
                          ),
                        );
                      }),
                      Obx(() {
                        final bool isExpanded =
                            controller.isWeaveTypeExpanded.value;
                        ...
                        return StatelessExpandableInputCard(
                          ...
                          bottomWidget: Obx(
                            () => WeaveTypeWidget(
                              ...
                              onChanged: (value) =>
                                  controller.selectedWeaveType.value = value,
                            ),
                          ),
                        );
                      }),
                  ...
                  FabricReviewContinueButton(controller: controller),
                ],
              ),
            ),
          ],
