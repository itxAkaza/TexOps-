...
class WeaveTypeWidget extends StatelessWidget {
  final String selectedValue;
  final ValueChanged<String> onChanged;

  const WeaveTypeWidget({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        const Text(
          'Selection: Plain / Satin / Twill',
          style: TextStyle(color: Colors.grey, fontSize: 12),
        ),
        const SizedBox(height: 12),
        Row(children: [option('Plain'), option('Satin'), option('Twill')]),
        const SizedBox(height: 8),
        Text(
          'Selected Weave Type: $selectedValue',
