...
import 'package:texops/screens/admin/bale_inventory/widgets/filterBottomSheet.dart';
import 'package:texops/screens/admin/bale_inventory/widgets/inventory_card.dart';
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return Padding(
                  ...
                  child: Obx(() {
                    // <-- Placed Obx exactly where the changing variable is read
                    bool isSelected =
                        controller.selectedQuickFilter.value == filter;
          ...
          Expanded(
            child: Obx(() {
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return BaleInventoryCard(
                    bale: controller.filteredBales[index],
                  );
                },
              );
            }),
