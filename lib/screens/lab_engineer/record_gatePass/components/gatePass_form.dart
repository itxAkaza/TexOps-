  ...
  Widget build(BuildContext context) {
    ...
    return Align(
      ...
      child: SingleChildScrollView(
        child: Form(
          key: baleController.formKeyStep1,
          child: Column(
            ...
            children: [
              ...
              _buildTextField(
                ...
                validator: (value) => value == null || value.trim().isEmpty ? 'Please enter Gate Pass ID' : null,
              ),
              ...
              BailButton(
                onTap: () {
                  ...
                  if (baleController.formKeyStep1.currentState!.validate()) {

                    if (baleController.selectedSupplier.value == null) {
                      Utils.toastMesseges("pls Select a supplier");
                      return;
                    }

                    baleController.goToNextStep();
                  }
                },
...
Widget _buildTextField({required String text,required String hint,required TextEditingController controller,TextInputType type=TextInputType.text,String? Function(String?)? validator}){
  return Padding(
